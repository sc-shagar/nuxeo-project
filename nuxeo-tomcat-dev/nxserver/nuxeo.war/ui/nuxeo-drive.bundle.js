...
(self.webpackChunk_nuxeo_nuxeo_web_ui=self.webpackChunk_nuxeo_nuxeo_web_ui||[]).push([[548],{85332:(e,t,o)=>{"use strict";o.r(t);var n=o(21536),i=o(66538),a=o(41608),s=o(30883);let r;(0,n.k)({_template:i.d`
  ...
  `,is:"nuxeo-drive-sync-toggle-button",behaviors:[a.mB,s.q],properties:{document:{type:Object,observer:"_update"},synchronized:{type:Boolean,notify:!0,reflectToAttribute:!0},synchronizationRoot:String,showLabel:{type:Boolean,reflectToAttribute:!0,value:!1},_label:{type:String,computed:"_computeLabel(synchronized, i18n)"}},toggle(){const e=!this.synchronized;return this.$.op.params={enable:!this.synchronized},this.$.op.execute().then((()=>{const t=r.indexOf(this.document.uid);e&&-1===t?r.push(this.document.uid):e||-1===t||r.splice(t,1),this.synchronized=e}))},_isAvailable(){if(!this.document)return!1;if(this.isVersion(this.document))return!1;const e=-1!==["Domain","SectionRoot","TemplateRoot","WorkspaceRoot","Forum","Collections"].indexOf(this.document.type),t=(this.hasFacet(this.document,"Collection")||this.hasFacet(this.document,"Folderish"))&&!this.isTrashed(this.document);return!e&&t&&!this.synchronizationRoot},_computeLabel(e){return e?this.i18n("driveSyncToggleButton.unsync","Unsynchronize"):this.i18n("driveSyncToggleButton.sync","Synchronize")},_icon:e=>e?"notification:sync-disabled":"notification:sync",_update(){if(!this.document||!r)return;this.synchronized=-1!==r.indexOf(this.document.uid);const e=this.document.contextParameters.breadcrumb.entries;for(let t=e.length-1;t>=0;t--)if(-1!==r.indexOf(e[t].parentRef))return void(this.synchronizationRoot=e[t].parentRef);this.synchronizationRoot=null},_handleRoots(e){r=e.detail.response.entries.map((e=>e.uid)),this._update()}}),(0,n.k)({_template:i.d`
  ...
  `,is:"nuxeo-authentication-tokens-management",properties:{application:String,tokens:{type:Array,value:[]}},behaviors:[a.mB],_params:e=>({application:e}),_handleTokens(e){this.tokens=e.detail.response.entries},_revoke(e){this.$.token.path=`/token/${e.model.token.id}`,this.$.token.remove().then(this.refresh.bind(this)).then((()=>{this.$.toast.open()}))},refresh(){return this.$.tokens.execute(this)},_empty:e=>!e.length,_formatDate:e=>(0,l.Z)(e).format("MMMM D, YYYY")}),(0,n.k)({_template:i.d`
    <style include="iron-flex iron-flex-alignment iron-flex-factors">
      :host {
        display: block;
      }
