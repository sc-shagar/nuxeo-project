import{Polymer}from"@polymer/polymer/lib/legacy/polymer-fn.js";import{html}from"@polymer/polymer/lib/utils/html-tag.js";import{I18nBehavior}from"@nuxeo/nuxeo-ui-elements/nuxeo-i18n-behavior.js";Polymer({_template:html`
  ...
  `,is:"nuxeo-3d-transmission-formats",properties:{document:{type:Object,notify:!0}},behaviors:[I18nBehavior],_hasItems:e=>e.length>0,_formatAsReadable(e,t,o){if((e=Number(e))<t)return`${e} ${o}`;const i=parseInt(Math.log(e)/Math.log(t),0),a=String("kMGTPE".charAt(i-1));return`${Math.round(e/t**i*10)/10} ${a}${o}`},_getPolyInfo(e){const t=null==e.percPoly?"":`${e.percPoly} %`,o=null==e.maxPoly?"":`< ${this._formatAsReadable(e.maxPoly,1e3,"")}`;return null!=e.percPoly&&null!=e.maxPoly?`${t} | ${o}`:t+o},_getPolyNumber(e){return this._formatAsReadable(e.info.polygons,1e3,"")},_hasTextures:e=>e.info.textures_size>0,_getTexInfo(e){const t=null==e.percTex?"":`${e.percTex} %`,o=null==e.maxTex?"":`< ${e.maxTex}`;return null!=e.percTex&&null!=e.maxTex?`${t} | ${o}`:t+o},_getTexSize(e){return this._hasTextures(e)?this._formatAsReadable(e.info.textures_size,1024,"B"):null},_loadFormat(e){this.fire("3d-viewer-content-change",{content:e.model.format.content.data})},_downloadFormat(e){window.location.href=e.model.format.content.data}});