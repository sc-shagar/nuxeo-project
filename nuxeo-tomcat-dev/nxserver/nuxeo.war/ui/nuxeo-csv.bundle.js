/*! For license information please see nuxeo-csv.bundle.js.LICENSE.txt */
(self.webpackChunk_nuxeo_nuxeo_web_ui=self.webpackChunk_nuxeo_nuxeo_web_ui||[]).push([[206],{43083:(e,t,i)=>{"use strict";i.r(t);var s=i(21536),o=i(66538),r=i(14190),a=i(41608),l=i(30883),n=i(9986),p=i(5453),d=i(49173);(0,s.k)({_template:o.d`
  ...
  `,is:"nuxeo-document-import-csv",behaviors:[a.mB,r.z,n.S,d.U,p.N,l.q],properties:{accept:{type:String,value:".csv"},hasFile:{type:Boolean,value:!1},file:{type:Object},complete:{type:Boolean,value:!1},_importDocTypes:{type:Array,computed:"_computeImportDocTypes(subtypes)"},visible:{type:Boolean},_creating:{type:Boolean,value:!1},_importResult:{type:Object},_importLogs:{type:Array,value:[]},_hasResult:{type:Boolean,value:!1},stage:{type:String,value:"upload"},_count:{type:Number,value:0},_total:{type:Number,value:0},_error:{type:Boolean,value:!1},receiveEmailReport:{type:Boolean,value:!1},enableImportMode:{type:Boolean,value:!1},progressLabel:{type:String,value:""}},_canImport(){return this.hasFile&&!this._creating},ready(){this.connection=this.$.nx,this.setupDropZone(this.$.dropzone),this._clear()},observers:["_observeFiles(files.*)","_visibleOnStage(visible,stage)","_observeVisible(visible)"],_i18n(e,t){return t&&0!==t.length?1===t.length?this.i18n(e,t[0]):this.i18n(e,t[0],t[1]):this.i18n(e)},_filterLogs(e){return e.filter((e=>this._isError(e)||this._isSkipped(e)))},_isError:e=>"ERROR"===e.status,_isSkipped:e=>"SKIPPED"===e.status,_observeVisible(){this.visible?this._clear():this._waitProgressId&&clearTimeout(this._waitProgressId)},_removeBlob(){this.$.csvImportRes.path=`upload/${this.batchId}/0`,this.$.csvImportRes.remove().then((()=>{this.file={},this.hasFile=!1,this.$.uploadFiles.value=""}),this._handleError.bind(this))},_computeImportDocTypes(){if(this.subtypes)return this.subtypes.filter(this._filterImportDocTypes)},_filterImportDocTypes:e=>-1===window.nuxeo.importBlacklist.indexOf(e.type),_observeFiles(e){e&&("files.splices"===e.path&&e.value&&e.value.indexSplices?this.files&&this.files.length>0&&([this.file]=this.files,this.hasFile=!0,this._creating=!0):e.path.match(/files\.\d+\.complete/gi)&&(this.complete=!0,this._creating=!1))},_showUploadDialog(){this.$.uploadFiles.click()},_fileChanged(e){this.uploadFiles(e.target.files),this.hasFile=!0},_visibleOnStage(){this.$.pathSuggesterUpload.disabled=!this.visible||"upload"!==this.stage},_clear(){this.stage="upload",this.files=[],this.file={},this.hasFile=!1,this._creating=!1,this._importResult={},this._total=0,this._count=0,this.$.importProgress.indeterminate=!0,this._error=!1,this.$.uploadFiles.value="",this._hasResult=!1,this.progressLabel="",this._importLogs=[]},_handleError(e){this._toast(`ERROR: ${e.message}`)},_toast(e){this.$.toast.text=e,this.$.toast.open()},_cancel(){this.batchId&&this.cancelBatch(),this._clear(),this.stage="upload",this.fire("nx-creation-wizard-show-tabs")},_import(){this.$.csvImportRes.path=`upload/${this.batchId}/0/execute/CSV.Import`,this.$.csvImportRes.data={params:{path:this.targetPath,sendReport:this.receiveEmailReport,documentMode:this.enableImportMode}},this.$.csvImportRes.post().then((e=>{this.stage="progress",this._waitProgressId=window.setTimeout(this._waitForProgress.bind(this),500,e)}),this._handleError.bind(this))},_waitForProgress(e){this.$.cvsImportStatus.input=e,this.$.cvsImportStatus.execute().then((t=>{const i=t.value;this._total=i.totalNumberOfDocument,this._total>=0&&(this.$.importProgress.indeterminate=!1),"ERROR"===i.state?this._error=!0:"RUNNING"===i.state||"SCHEDULED"===i.state?(this._count=i.numberOfProcessedDocument,this._total>=0?this.progressLabel=this.i18n("csv.import.progress.statusWithTotal",this._count,this._total):this.progressLabel=this.i18n("csv.import.progress.statusWithoutTotal",this._count),this._waitProgressId=window.setTimeout(this._waitForProgress.bind(this),800,e)):"COMPLETED"===i.state?(this._count=i.numberOfProcessedDocument,this._waitProgressId=null,this._count<0?this._error=!0:(this.$.cvsImportLogOp.input=e,this.$.cvsImportLogOp.execute().then((e=>{this._importLogs=this._filterLogs(e.value),this.$.list.notifyResize()})),this.$.cvsImportResultOp.input=e,this.$.cvsImportResultOp.execute().then((e=>{this._importResult=e.value,this._hasResult=!0})))):this._handleError({message:"Error while processing: unknown status."})}),this._handleError.bind(this))},_close(){"progress"===this.stage&&this._count>0&&(this.fire("document-updated"),this.navigateTo("document",this.parent)),this._waitProgressId&&clearTimeout(this._waitProgressId)}});var c=i(50570),m=i.n(c);const u=document.createElement("template");u.innerHTML=m(),document.head.appendChild(u.content)},50570:e=>{e.exports=' <nuxeo-slot-content name="csvDocumentCreatePopup" slot="CREATE_POPUP_ITEMS" order="30"> <template> <paper-tab name="importCSV">[[i18n(\'csv.import\')]]</paper-tab> </template> </nuxeo-slot-content> <nuxeo-slot-content name="csvDocumentCreatePopup" slot="CREATE_POPUP_PAGES"> <template> <nuxeo-document-import-csv id="csvCreation" name="importCSV" parent="[[parent]]" target-path="{{parentPath}}" suggester-children="{{suggesterChildren}}"></nuxeo-document-import-csv> </template> </nuxeo-slot-content> '}}]);