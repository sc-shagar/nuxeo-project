...
(self.webpackChunk_nuxeo_nuxeo_web_ui=self.webpackChunk_nuxeo_nuxeo_web_ui||[]).push([[644],{51704:(e,o,n)=>{"use strict";n.r(o);var i=n(21536),t=n(66538),a=n(41608),l=n(30032),r=n(16896);(0,i.k)({_template:t.d`
    <style>
      :host {
  ...
  `,is:"nuxeo-easyshare-share-link",behaviors:[a.mB],properties:{document:{type:Object},icon:{type:String,value:"nuxeo:share"},showLabel:{type:Boolean,value:!1},_label:{type:String,computed:"_computeLabel(i18n)"}},_toggleDialog(){this.$.dialog.toggle()},_isAvailable:e=>e,_isEasyshare:e=>e&&"EasyShareFolder"===e.type,_buildPermalink:e=>e?`${window.location.origin+window.location.pathname}#!/doc/${e.uid}`:"",_buildEasysharelink(e){const o=window.location.origin+this.$.nxcon.url;return e?`${o}/site/easyshare/${this.document.uid}`:""},_computeLabel(){return this.i18n("shareButton.tooltip")},_copyLink(e){const o=e.currentTarget,n=o.previousElementSibling,i="easyShareIcon"===o.id?this.$.permalinkIcon:this.$$("#easyShareIcon");i&&"none"!==i.display&&i._debouncer&&i._debouncer.isActive()&&(i._debouncer=i._debouncer.flush()),n.$.paperInput.$.nativeInput.select(),window.document.execCommand("copy")&&(o._debouncer=l.dx.debounce(o._debouncer,r.timeOut.after(2e3),(()=>{n.$.paperInput.$.nativeInput.setSelectionRange(0,0),n.$.paperInput.blur(),o.set("icon","link"),o.classList.remove("selected")})),o.set("icon","check"),o.classList.add("selected"),this.fire("notify",{message:this.i18n("shareButton.operation.copied"),duration:2e3}))}});var s=n(87358),c=n.n(s);const u=document.createElement("template");u.innerHTML=c(),document.head.appendChild(u.content)},87358:e=>{e.exports=' <nuxeo-slot-content name="shareDocumentAction" slot="DOCUMENT_ACTIONS" order="40" priority="10"> <template> <nuxeo-easyshare-share-link document="[[document]]"></nuxeo-easyshare-share-link> </template> </nuxeo-slot-content> '}}]);